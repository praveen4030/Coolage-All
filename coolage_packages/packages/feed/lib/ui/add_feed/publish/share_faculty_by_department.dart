...
class ShareFacultyByDepartmentWidget extends StatefulWidget {
  final List<String> selectedGroupsList;
  final String groupName;
  const ShareFacultyByDepartmentWidget({
    Key? key,
  ...
  @override
  _ShareFacultyByDepartmentWidgetState createState() =>
      _ShareFacultyByDepartmentWidgetState();
}

class _ShareFacultyByDepartmentWidgetState
    extends State<ShareFacultyByDepartmentWidget> {
  @override
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return SelectGroupTile(
                    ...
                    onSelect: () {
                      showFacultyDesignationsForDepartmentDialog(
                          selectedDepp[index]);
                    },
  ...
  Future<void> showFacultyDesignationsForDepartmentDialog(
      ...
      builder: (context) {
        return SelectItemsListDialog(
          ...
          onItemTap: (String value, bool isAdded) {
            if (isAdded) {
              final designations =
                  CollegeGetters.getCurrentUserCollegeDesignations(
                context,
              );
              for (final designation in designations) {
                String s = "${widget.groupName}_${value}_$designation";
