...
class ShareFacultyByDesignationWidget extends StatefulWidget {
  final List<String> selectedGroupsList;
  final String groupName;
  const ShareFacultyByDesignationWidget({
    Key? key,
  ...
  @override
  _ShareFacultyByDesignationWidgetState createState() =>
      _ShareFacultyByDesignationWidgetState();
}

class _ShareFacultyByDesignationWidgetState
    extends State<ShareFacultyByDesignationWidget> {
  @override
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return SelectGroupTile(
                    ...
                    onSelect: () {
                      showDepartmentsForDesignationsDialog(
                          selectedYearGroups[index]);
                    },
  ...
  Future<void> showDepartmentsForDesignationsDialog(String yearGroup) async {
  ...
  Future<void> showDesignationsGroupsDialog() async {
    final selectedList = FeedFunctions.getSelectedYearGroups(
        widget.selectedGroupsList, widget.groupName);
    final itemsList = CollegeGetters.getCurrentUserCollegeDesignations(context);
    await showDialog(
      context: context,
      builder: (context) {
