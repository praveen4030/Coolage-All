...
class PublishFeedHeader extends StatelessWidget {
  final String category;
  final Function onChange;
  final DateTime? selectedDate;
  final Function? onDateChange;
  final Function onCancelDate;
  const PublishFeedHeader({
    Key? key,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          //query doesnt work with both expiory and timestamp condition
          if (category == "Expired" || category == "Live")
            Container()
          else
